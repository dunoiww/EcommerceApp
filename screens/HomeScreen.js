            ...
            <SafeAreaView style={styles.container}>
                <ScrollView>
                    <Header
                        ...
                        setSearchText={setSearchText}></Header>
                    ...
                    <Pressable
                        ...
                        <Pressable>
                            {selectedAddress ? (
                                <Text style={{fontSize: 14, fontWeight: '500'}}>Delivery to {selectedAddress?.name} - {selectedAddress?.street} </Text>
                            ) : (
                    ...
                    <Text style={styles.tredingText}>Today's Deals</Text>
                ...
                <ModalContent style={{ width: "100%", height: 400 }}>
                    <View>
                        ...
                        <Text
                            ...
                            availability and delivery option
                        </Text>
                    </View>
